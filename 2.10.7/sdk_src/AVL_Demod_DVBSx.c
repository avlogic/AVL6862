...
AVL_ErrorCode AVL_Demod_DVBSxManualLock(AVL_DVBSxManualLockInfo *pstManualLockInfo, AVL_uint32 uiChipNo)
{
    ...
    if(eFuncMode == AVL_FuncMode_Demod)
    {
        ...
        {
            r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_dvbs_fec_coderate_iaddr_offset, pstManualLockInfo->eDVBSCodeRate);
        }
        else if(pstManualLockInfo->eDVBSxStandard == AVL_DVBS2 )
        {
            r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_dvbs2_code_rate_saddr_offset, pstManualLockInfo->eDVBS2CodeRate);
            r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_dvbs2_modulation_saddr_offset, pstManualLockInfo->eDVBSxModulationMode);
        }
        else
        {
            return AVL_EC_NOT_SUPPORTED;
        }
        r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_decode_mode_saddr_offset, pstManualLockInfo->eDVBSxStandard);

        if(pstManualLockInfo->eDVBSxSpecInversion == AVL_SPECTRUM_AUTO)
        {
            r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_iq_mode_saddr_offset, 1);//enable spectrum auto detection
        }
        else
        {
            r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_specinv_iaddr_offset, pstManualLockInfo->eDVBSxSpecInversion);
            r |= II2C_Write16_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_iq_mode_saddr_offset, 0);
        }
        
        r |= II2C_Write32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_int_sym_rate_MHz_iaddr_offset, pstManualLockInfo->uiDVBSxSymbolRateSps);
...
AVL_ErrorCode AVL_Demod_DVBSxGetModulationInfo(AVL_DVBSxModulationInfo *pstModulationInfo, AVL_uint32 uiChipNo)
{
    ...
    r = II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_status_reg_base + rs_DVBSx_pilot_iaddr_offset, &uiTemp);
    pstModulationInfo->eDVBSxPilot = (AVL_DVBSx_Pilot)(uiTemp);

    r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_internal_decode_mode_iaddr_offset,&uiTemp);
    pstModulationInfo->eDVBSxStandard = (AVL_DVBSx_Standard)uiTemp;

    if(AVL_DVBS == (AVL_DVBSx_Standard)uiTemp)
    {
        r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_dvbs_fec_coderate_iaddr_offset,&uiTemp);
        pstModulationInfo->eDVBSCodeRate = (AVL_DVBS_CodeRate)(uiTemp);
    }
    else
    {
        r |= II2C_Read8_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_config_reg_base + rc_DVBSx_dvbs2_fec_coderate_caddr_offset,&temp_uchar);
        pstModulationInfo->eDVBS2CodeRate = (AVL_DVBS2_CodeRate)(temp_uchar);
    }

    r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_status_reg_base + rs_DVBSx_modulation_iaddr_offset, &uiTemp);
    pstModulationInfo->eDVBSxModulationMode = (AVL_DVBSx_ModulationMode)(uiTemp);
    
    r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, gstChipInternalArray[uiChipNo].stBaseAddrSet.fw_DVBSx_status_reg_base + rs_DVBSx_detected_alpha_iaddr_offset, &uiTemp);
...
AVL_ErrorCode AVL_Demod_DVBSx_BlindScan_ReadChannelInfo(AVL_uint16 uiStartIndex, AVL_puint16 pChannelCount, AVL_ChannelInfo * pChannel, AVL_uint32 uiChipNo)
{
    ...
    for( i1=0; i1<(*pChannelCount); i1++ )
    {
        ...
        r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, channel_addr, &(pChannel[i1].m_uiFrequency_kHz));
        channel_addr += 4;
        r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, channel_addr, &(pChannel[i1].m_uiSymbolRate_Hz));
        channel_addr += 4;
        r |= II2C_Read32_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, channel_addr, &(pChannel[i1].m_Flags));
        channel_addr += 4;
#endif      
    }
    ...
    if( AVL_DOS_InModulation == gstChipInternalArray[uiChipNo].stDVBSxPara.eDiseqcStatus )
    {
        ...
        if( (!((i2>>8) & 0x01 ) && (0x00000004 == (i1 & 0x00000004))) || (((i2>>8) & 0x01 ) &&(0x00000004 != (i1 & 0x00000004))))
        {
            *pucSize = (AVL_uchar)((i1 & 0x00000078)>>3);
            ...
            {
                r |= II2C_Read_Demod(gstChipInternalArray[uiChipNo].usI2CAddr,
    ...
    else
    {
        ...
        if( AVL_EC_OK ==  r)
        {
            ...
            for( i2=0; i2<ucSize; i2++ )
            {
                ...
                r |= II2C_Write_Demod(gstChipInternalArray[uiChipNo].usI2CAddr, pucBuffTemp, 7);
            }                           
