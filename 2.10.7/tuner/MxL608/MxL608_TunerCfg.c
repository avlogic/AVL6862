...
MXL608_STATUS MxL608_Ctrl_ProgramRegisters(UINT8_608 devId, PMXL608_REG_CTRL_INFO_T ctrlRegInfoPtr)
{
...
MXL608_STATUS MxL608_Ctrl_WriteRegField(UINT8_608 devId, PMXL608_REG_CTRL_INFO_T ctrlRegInfoPtr)
{
  MXL608_STATUS status = MXL608_TRUE;
  UINT8_608 tmp = 0;
...
MXL608_STATUS Ctrl_SetRfFreqLutTblReg(UINT8_608 devId, UINT32_608 FreqInHz, PMXL608_CHAN_DEPENDENT_FREQ_TABLE_T freqLutPtr)
{
