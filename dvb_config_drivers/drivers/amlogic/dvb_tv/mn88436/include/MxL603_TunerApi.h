...
#define MXL603_I2C_ADDR 0x60;//0xC0//(0x60<<1)
...
extern MXL_STATUS MXL603_INIT(DMD_PARAMETER* param);
extern MXL_STATUS Mxl603SetSystemMode(void);
extern MXL_STATUS Mxl603SetFreqBw(DMD_PARAMETER* param);
extern MXL_STATUS Mxl603_set_system(int is8VSB);
