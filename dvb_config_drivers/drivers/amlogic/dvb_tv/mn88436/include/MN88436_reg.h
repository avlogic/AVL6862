...
#ifndef DMD_MN88436_H
#define DMD_MN88436_H

//for recomendation register setting
extern DMD_u8_t DMD_REG_ATSC[];
extern DMD_u8_t DMD_REG_QAM_B_64QAM[];
extern DMD_u8_t DMD_REG_QAM_B_256QAM[];
extern DMD_u8_t DMD_BANK_MAIN(DMD_u8_t id);
extern DMD_u8_t DMD_BANK_USR(DMD_u8_t id);

//PSEQ
extern DMD_u8_t				MN88436_REG_AUTOCTRL[];
extern DMD_u32_t			MN88436_REG_AUTOCTRL_SIZE;
...
extern DMD_u8_t	DMD_I2C_SLAVE[DMD_MAX_DEVICE][DMD_REG_BANK];
