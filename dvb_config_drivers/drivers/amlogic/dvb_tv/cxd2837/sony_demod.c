/*------------------------------------------------------------------------------
  ...
  Last Updated  : $Date:: 2013-05-02 10:19:37 #$
  File Revision : $Revision:: 7019 $
------------------------------------------------------------------------------*/
                                 ...
                                 sony_i2c_t * pDemodI2c)
{
	...
	printk("[sony_demod.c]: sony_demod_Create(): \n");
    ...
    pDemod->i2cAddressSLVX = 0x6E;//i2cAddress + 4;
...
{
    sony_result_t result = SONY_RESULT_OK;
	printk("[sony_demod.c]: sony_demod_InitializeT_C(): \n");
...
{
    sony_result_t result = SONY_RESULT_OK;
	printk("[sony_demod.c]: sony_demod_Shutdown(): \n");
...
{
    sony_result_t result = SONY_RESULT_OK;
	printk("[sony_demod.c]: sony_demod_TuneEnd(): \n");
...
{
    sony_result_t result = SONY_RESULT_OK;
	printk("[sony_demod.c]: sony_demod_SoftReset(): \n");
...
{
    sony_result_t result = SONY_RESULT_OK;
	printk("[sony_demod.c]: sony_demod_SetConfig(): \n");
