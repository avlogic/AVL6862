...
#else
//#define CONFIG_TH_CXD2837_DVBC_ENABLE
#define CONFIG_SONY2837_TUNER_2872
#define CONFIG_SONY2837_DEMOD_XTAL_20500KHZ
    #ifdef CONFIG_SONY2837_TUNER_2872
...
------------------------------------------------------------------------------*/
#define SONY_EXAMPLE_TUNER_XTAL             16
#define SONY_EXAMPLE_TUNER_I2C_ADDRESS      0x60//SONY_ASCOT2E_ADDRESS
 ...
 */
#define SONY_EXAMPLE_TUNER_FLAGS            SONY_ASCOT2E_CONFIG_IFAGCSEL_ALL2//
 ...
 */
//#define SONY_EXAMPLE_TUNER_FLAGS            0
#define	SONY_EXAMPLE_TUNER_FLAGS			SONY_ASCOT3_CONFIG_IFAGCSEL_ALL2

/* ASCOT3 specific const char definitions */
static const char *ASCOT3_Xtal[] = {"16", "20.5", "24", "41"};
...
/*------------------------------------------------------------------------------
  Demodulator
------------------------------------------------------------------------------*/
#ifdef CONFIG_SONY2837_DEMOD_XTAL_20500KHZ
#define SONY_EXAMPLE_DEMOD_XTAL             SONY_DEMOD_XTAL_20500KHz
#else
...
#ifdef CONFIG_TH_CXD2837_TUNER_MXL603
#define SONY_EXAMPLE_DVBT_8MHz_IF           5.00
#else
...
#ifdef CONFIG_TH_CXD2837_TUNER_MXL603
#define SONY_EXAMPLE_DVBT2_8MHz_IF          5.00
#else
#define SONY_EXAMPLE_DVBT2_8MHz_IF          4.80
#endif

#ifdef CONFIG_TH_CXD2837_TUNER_MXL603
#define SONY_EXAMPLE_DVBC_IF                	    5.00
#else
	#ifdef DVBC_6M_BAND
#define SONY_EXAMPLE_DVBC_IF                	    3.70
	#else
...
sony_example_demod_configuration_t demodulatorConfiguration[] = {
    ...
    { SONY_DEMOD_CONFIG_TSERR_ACTIVE_HI,                    0},     /* TS error polarity        [0-1]     0 : Valid low, 1 : Valid hi           */
     ...
     * ---------------------------------------------------------------------------------------------------------------------------------------- */
#ifndef SONY_DRIVER_DVBC
    { SONY_DEMOD_CONFIG_TERR_BLINDTUNE_DVBT2_FIRST,         1},     /* Blind tune priority      [0-1]     0 : DVB-T first, 1 : DVB-T2 first     */
#endif
